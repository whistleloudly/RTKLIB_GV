...
#define DDOPT   "0:dd_standard,1:sd_standard"  /*hy add 20210315*/
#define PFOUTPUT "0:off,1:output_enu,2:output_Lbias"/*hy add 20210325*/
...
EXPORT opt_t sysopts[] = {
    ...
    {"pos2-ddmode",     3,  (void*)&prcopt_.ddmode,      DDOPT  },/*DD mode */ /*wmk20141021 added */
    {"pos2-pfnum",      0,  (void*)&prcopt_.pfnum,       ""     },/* particle filter number */ /*hy20210317 added */
    {"pos2-pfoutput",   3,  (void*)&prcopt_.pfoutput,    PFOUTPUT},
    {"pos2-est_CLbias", 0,  (void*)&prcopt_.est_CLbias,  ""     },/*hy add 20210405:for est Lbias of pseudorange*/
    {"pos2-pfopt",      0,  (void*)&prcopt_.pfopt,  ""     },
...
static void buff2sysopts(void)
{
    ...
    /* number of frequency (4:L1+L5) */     //hy add 20211228:这个地方没看懂作用是啥
    if (prcopt_.nf == 4) {
        //prcopt_.nf=3;
        //prcopt_.freqopt=1;
    }
