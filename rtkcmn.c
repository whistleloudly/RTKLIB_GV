...
const prcopt_t prcopt_default = { /* defaults processing options */
    ...
    0,0,0,0,0,                  /* ddmode,PF number,est_pseudorange_Lbias,PF optimization parameters */
...
static char codepris[7][MAXFREQ][16] = {  /* code priority for each freq-index */
   /*    0         1          2          3         4         5     */
    ...
    {"C"       ,"IQX"       ,""        ,""       ,""       ,""      ,""}, /* SBS */
    /*B1I         B1C           B2a        B3I      B2I/B2b        B2ab     B2b*/
    //"IQX" ,"DPXABCZSLGHJ" ,"DPXIQ","IQXGHJKMNA","IQXDPZABC"    ,"DPX"   ,"DPZ"
    {"DPXABCZSLGHJ" ,"DPXIQ" ,"IQXDPZABC",     "IQX","IQXGHJKMNA" ,"DPX"   ,"DPZ"}, /* BDS */
    {"ABCX"    ,"ABCX"      ,""        ,""       ,""       ,""      ,""}  /* IRN */
};
...
static int code2freq_BDS(uint8_t code, double* freq)
{
    ...
    //}
    if (strcmp(obs, "7D") == 0 || strcmp(obs, "7P") == 0 || strcmp(obs, "7Z") == 0) {
        *freq = FREQ2_CMP;       return 6; /* B2b */
    }

    switch (obs[0]) {//hy 20211102:修改了B1C和B3I的顺序
    case '1': *freq = FREQ1;     return 0; /* B1C */ /* 1 */
    case '2': *freq = FREQ1_CMP; return 3; /* B1I */
    case '5': *freq = FREQ5;     return 1; /* B2a */
    case '6': *freq = FREQ3_CMP; return 4; /* B3I */
    case '7': *freq = FREQ2_CMP; return 2; /* B2I */ /* 4 */
